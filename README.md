...
Lesson content is generated by the Anthropic Claude API (`claude-sonnet-5`), called directly from the browser with your own API key. Responses are streamed, so the word and sentence cards render before the role-play finishes generating.
...
3. Open the deployment, create an account, and paste your [Anthropic API key](https://console.anthropic.com/) when prompted.
