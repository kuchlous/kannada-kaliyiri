...
Return ONLY valid JSON (no markdown):
{"topic":"${topic}","word":{"kannada":"script","transliteration":"syllable-hyphenated e.g. na-ma-ste","partOfSpeech":"noun/verb/etc","example":"fun practical tip in English","intent":"the English meaning you intend this Kannada to have"},"sentence":{"kannada":"simple sentence using the word","transliteration":"words separated by spaces, no hyphens","intent":"the English meaning you intend","intent_hi":"the same sentence in Hindi"},"roleplay":{"scenario":"Short scenario title e.g. At the market","npcName":"e.g. Shopkeeper","lines":[{"speaker":"NPC","kannada":"...","transliteration":"words separated by spaces, no hyphens","intent":"...","intent_hi":"..."},{"speaker":"YOU","kannada":"...","transliteration":"words separated by spaces, no hyphens","intent":"...","intent_hi":"..."},{"speaker":"NPC","kannada":"...","transliteration":"words separated by spaces, no hyphens","intent":"...","intent_hi":"..."},{"speaker":"YOU","kannada":"...","transliteration":"words separated by spaces, no hyphens","intent":"...","intent_hi":"..."}]}}
Rules: level 1-3 = very basic vocab. Everyday Bangalore Kannada. Only the word of the day is hyphenated by syllable, to show how it is built; the sentence and every role-play line are transliterated as ordinary words separated by spaces, because hyphenating a whole line hides where the words are — write "ee daari neravaagi hogi", never "ee-daa-ri-ne-ra-vaa-gi-ho-gi". The word of the day must be NEW — never one of the already-learned words listed above. Roleplay must use today's word. Every "intent" is the English meaning you believe your Kannada carries. Every "intent_hi" is that same Kannada in Hindi (Devanagari), using the level of address your Kannada actually uses: ನೀನು → तू or तुम, ನೀವು → आप. Keep it consistent — if the Kannada says ನೀವು the Hindi must say आप, and if the Kannada addresses nobody the Hindi must not add a pronoun. Both are used only to check your Kannada against an independent translation and are never shown to the learner, so state them plainly and accurately. ONLY JSON.`;
